...
const PROJECTS = [
  {
    ...
    number: '01',
    category: 'Full Stack',
    tags: ['React', 'Node.js', 'Express', 'PostgreSQL', 'JWT', 'Git/GitHub'],
    bullets: [
      'Built full-stack PERN platform for point-based item lending with secure JWT auth.',
      'Designed PostgreSQL schema with ACID transactions for atomic point transfers.',
      'Implemented end-to-end borrowing workflow — requests through returns with penalties.',
      'Created audit trail system tracking all transaction history.',
      'Optimized Node.js queries with indexes, achieving 40% speed improvement.',
    ],
